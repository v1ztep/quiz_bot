...
from telegram.utils.helpers import (
    decode_user_chat_data_from_json, decode_conversations_from_json,
...
class RedisPersistence(BasePersistence):
    def __init__(self, host: str, port: int, db: int, password: str = None,
                 *args, **kwargs) -> None:
        self.r_conn = Redis(host=host, port=port, db=db, password=password,
    ...
    def update_chat_data(self, chat_id: int, data: CD) -> None:
        ...
        if chat_data is None:
            ...
            chat_data = defaultdict(dict,
                                    decode_user_chat_data_from_json(chat_data))
    ...
    def update_user_data(self, user_id: int, data: UD) -> None:
        ...
        if user_data is None:
            ...
            user_data = defaultdict(dict,
                                    decode_user_chat_data_from_json(user_data))
